...
START
Ask user if they are a beginner to Te Reo Maori
If the user enters Y, go to the "easy" method
If the user enters N, go to the "hard" method
If the user's score is less than or equal to 3, they will be asked if they want to try the easy set of questions or end the program
If the user enters Y, go to the "easy" method
If the user enters N, end the program
If the user's score is more than or equal to 4, they will be asked if they want to try the hard set of questions or end the program
If the user enters Y, go to the "hard" method
If the user enters N, end the program
If the user's score is less than or equal to 9, they will be asked if they want to try the easy set of questions or end the program
If the user enters Y, go to the "easy" method
If the user enters N, end the program
If the user's score is more than or equal to 10, the program will end
END
...
namespace MaoriQuiz
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                int score = 0;
                while (true) // Loops forever unless told to break
            { 
                ...
                switch (ans1)
                {
                    case "A":
                            ...
                            Console.ResetColor();
                            break; // Breaks out of the switch case but not the loop
